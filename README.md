...
- マイクボタンを **長押し中だけ録音**（押した瞬間に開始、離すと終了）
- 指を離すと自動で文字起こし → 即投稿
- 全投稿を新着順にタイムライン表示（Vercel KV で全ユーザー間共有）
- 果物スタンプでリアクション（🍑 わかる / 🍋 ちょっとすっぱい / 🌱 育ちそう / 🫐 じんわりくる / 🍒 好き）
- ゲストでも投稿・閲覧・リアクション可能（cookie で sessionId を保持）
...
| MVP v1 | ElevenLabs Scribe v2 + Vercel KV + 果物スタンプ | ✅ |
