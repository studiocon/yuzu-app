...
- INSIGHT > SENTIMENT の `MONTH` / `ALL`（[components/LongSentimentChart.tsx](components/LongSentimentChart.tsx)）
...
| 2 | INSIGHT | FileText | "INSIGHT" | AI 解釈と集計（SENTIMENT / WORDS / SIGNAL / PATTERN / REPORTS） | AI と集計（他者視点）| |
...
├──────────────────────────────┤
│  LOG:     STATS / RECORDS    │
│  INSIGHT: SENTIMENT / WORDS  │
│  / SIGNAL / PATTERN / REPORTS│
└──────────────────────────────┘
           ↑ タブコンテンツ
